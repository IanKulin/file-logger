...
import path from "node:path"
  ...
  initLogFile() {
    ...
    // Enhanced log method with queuing and error handling
    log(message) {
      ...
      this.writeQueue = this.writeQueue
        ...
        .catch(error => this.handleLogError(error, logEntry))
    }
    ...
    handleLogError(error, logEntry) {
      this.errorHandler('Logging failed', error)
      // Optionally, implement a backup logging mechanism
      console.error(`Failed to log: ${logEntry}`)
    }
